...
#define RGMII_IO_MACRO_CONFIG_RGOFFADDR ((__volatile__ ULONG *) (RGMII_IO_BASE_ADDRESS + RGMII_IO_MACRO_CONFIG_RGOFFADDR_OFFSET))
...
#define SDCC_HC_REG_DLL_CONFIG_RGOFFADDR ((__volatile__ ULONG *)(RGMII_IO_BASE_ADDRESS + SDCC_HC_REG_DLL_CONFIG_RGOFFADDR_OFFSET))
...
#define SDCC_HC_REG_DDR_CONFIG_RGOFFADDR ((__volatile__ ULONG *)(RGMII_IO_BASE_ADDRESS + SDCC_HC_REG_DDR_CONFIG_RGOFFADDR_OFFSET))
...
#define SDCC_HC_REG_DLL_CONFIG_2_RGOFFADDR ((__volatile__ ULONG *)(RGMII_IO_BASE_ADDRESS + SDCC_HC_REG_DLL_CONFIG_2_RGOFFADDR_OFFSET))
...
#define SDC4_STATUS_RGOFFADDR ((__volatile__ ULONG *)(RGMII_IO_BASE_ADDRESS + 0x00000014))
...
#define SDCC_USR_CTL_RGOFFADDR ((__volatile__ ULONG *)(RGMII_IO_BASE_ADDRESS + SDCC_USR_CTL_RGOFFADDR_OFFSET))
...
#define RGMII_IO_MACRO_CONFIG_2_RGOFFADDR ((__volatile__ ULONG *)(RGMII_IO_BASE_ADDRESS + RGMII_IO_MACRO_CONFIG_2_RGOFFADDR_OFFSET))
...
#define RGMII_IO_MACRO_DEBUG_1_RGOFFADDR ((__volatile__ ULONG *)(RGMII_IO_BASE_ADDRESS + 0x00000020))
...
#define EMAC_SYSTEM_LOW_POWER_DEBUG_RGOFFADDR ((__volatile__ ULONG *)(RGMII_IO_BASE_ADDRESS + 0x00000028))
