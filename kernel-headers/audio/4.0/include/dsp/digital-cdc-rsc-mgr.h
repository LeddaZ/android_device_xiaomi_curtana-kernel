...
static __inline__ int digital_cdc_rsc_mgr_hw_vote_enable(struct clk* vote_handle)
{
	return 0;
}

static __inline__ void digital_cdc_rsc_mgr_hw_vote_disable(struct clk* vote_handle)
{
}

static __inline__ void digital_cdc_rsc_mgr_hw_vote_reset(struct clk* vote_handle)
{
}
