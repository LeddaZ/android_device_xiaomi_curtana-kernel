...
#else
static __inline__ int msm_aud_evt_register_client(struct notifier_block *nb)
{
	return -ENOSYS;
}

static __inline__ int msm_aud_evt_unregister_client(struct notifier_block *nb)
{
	return -ENOSYS;
}

static __inline__ int msm_aud_evt_notifier_call_chain(unsigned long val, void *v)
{
	return -ENOSYS;
}

static __inline__ int msm_aud_evt_blocking_register_client(
			struct notifier_block *nb)
{
	return -ENOSYS;
}

static __inline__ int msm_aud_evt_blocking_unregister_client(
			struct notifier_block *nb)
{
	return -ENOSYS;
}

static __inline__ int msm_aud_evt_blocking_notifier_call_chain(
