...
#else
static __inline__ int msm_mdf_init(void)
{
	return 0;
}

static __inline__ void msm_mdf_exit(void)
{
	return;
}
#endif
...
#else
static __inline__ int spk_params_init(void)
{
	return 0;
}
static __inline__ void spk_params_exit(void)
{
}
#endif
...
#else
static __inline__ int audio_slimslave_init(void)
{
	return 0;
};
static __inline__ void audio_slimslave_exit(void)
{
};
#endif
...
#else
static __inline__ int voice_mhi_init(void)
{
	return 0;
}

static __inline__ void voice_mhi_exit(void)
{
	return;
}
#endif
...
#else
static __inline__ void digital_cdc_rsc_mgr_init(void)
{
}

static __inline__ void digital_cdc_rsc_mgr_exit(void)
{
}
