...
static __inline__ void *audio_ssr_register(int domain_id,
				       struct notifier_block *nb)
{
	return NULL;
}

static __inline__ int audio_ssr_deregister(void *handle, struct notifier_block *nb)
{
	return 0;
}

static __inline__ void audio_ssr_send_nmi(void *ssr_cb_data)
{
}
