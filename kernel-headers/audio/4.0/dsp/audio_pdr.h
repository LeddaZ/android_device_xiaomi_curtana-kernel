...
static __inline__ int audio_pdr_register(struct notifier_block *nb)
{
	return -ENODEV;
}

static __inline__ int audio_pdr_deregister(struct notifier_block *nb)
{
	return -ENODEV;
}

static __inline__ void *audio_pdr_service_register(int domain_id,
					       struct notifier_block *nb,
					       int *curr_state)
{
	return NULL;
...
static __inline__ int audio_pdr_service_deregister(void *service_handle,
					       struct notifier_block *nb)
{
	return 0;
}
