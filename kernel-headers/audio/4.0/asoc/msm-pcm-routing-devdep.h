...
#else
static __inline__ int msm_pcm_routing_hwdep_new(struct snd_soc_pcm_runtime *runtime,
				struct msm_pcm_routing_bdai_data *msm_bedais)
{
	return 0;
}

static __inline__ void msm_pcm_routing_hwdep_free(struct snd_pcm *pcm)
{
}
#endif
#endif
