...
static __inline__ int msm_anlg_cdc_mclk_enable(struct snd_soc_codec *codec,
					   int mclk_enable, bool dapm)
{
	return 0;
}
static __inline__ int msm_anlg_cdc_hs_detect(struct snd_soc_codec *codec,
				struct wcd_mbhc_config *mbhc_cfg)
{
	return 0;
}
static __inline__ void msm_anlg_cdc_hs_detect_exit(struct snd_soc_codec *codec)
{
